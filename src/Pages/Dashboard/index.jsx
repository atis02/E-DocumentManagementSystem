    ...
    <Box height="100vh" overflow="scroll" width="100%">
      <Stack p="20px">
        ...
        <Stack
          ...
          m="15px 0"
        >
          <Typography fontSize="24px" fontWeight="600" color="gray">
            Ähli Resminamalar
          </Typography>
          <Stack direction="row" alignItems="center">
            <TextField
              ...
              variant="outlined"
              autoComplete="off"
              sx={{ color: "#000", width: "350px", mr: "20px" }}
            ...
            {openFilter && (
              ...
              >
                ...
                <TextField
                  ...
                  variant="outlined"
                  autoComplete="off"
                  sx={{ color: "#000", width: "260px", ml: "40px" }}
        ...
        <Stack direction="row" justifyContent="space-between" m="0 90px 0 20px">
          <Typography textAlign="center">Dokument</Typography>
          <Typography textAlign="center">Ady</Typography>
          <Typography textAlign="center">Görnüşi</Typography>
          <Typography textAlign="center">Dörediji</Typography>
          <Typography textAlign="center">Ýagdaýy</Typography>
          <Typography textAlign="center">Senesi</Typography>
        </Stack>
        <Divider />

        <Stack spacing={2} mt="10px">
          {document.length <= 0 ? (
            <Typography textAlign="center" fontSize={18} pt="50px">
              Document not Found
            </Typography>
          ) : (
            document
              ...
              .map((item) => (
                ...
                >
                  ...
                  >
                    ...
                    <Typography textAlign="center" minWidth="70px">
                      {item.title}
                    </Typography>
                    <Typography textAlign="center" minWidth="55px">
                      {item.typeDoc}
                    </Typography>
                    <Typography textAlign="center" ml={2} minWidth="60px">
                      {item.sender}
                    </Typography>
                    <Stack direction="row" spacing={1}>
                      ...
                      ></Stack>
                      <Typography textAlign="center">{item.status}</Typography>
                    </Stack>
